...
Run `./gradlew app:linuxX64Test --rerun-tasks` (it may take several attempts, try to repeat 5-10 times).

The fails with the `IndexOutOfBoundsException` or similar exception.
